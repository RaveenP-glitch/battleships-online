...
-- AlterEnum
BEGIN;
CREATE TYPE "GameStatus_new" AS ENUM ('WAITING_FOR_PLAYER', 'PLACING_SHIPS', 'IN_PROGRESS', 'COMPLETED');
...
ALTER TABLE "games" ALTER COLUMN "status" SET DEFAULT 'WAITING_FOR_PLAYER';
COMMIT;
